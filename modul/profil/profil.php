<script type="text/javascript" src="modul/profil/ajax.js"></script>
<style type="text/css">
button {
	margin: 2px;
	position: relative;
...
echo "<div id='dalam_content'>
	...
	<table width='100%'>
		...
		<tr>
			<td>Kepala</td>
			<td width='2%'>:</td>
			<td><input type='text' name='pimpinan' id='pimpinan' size='30' maxlength='30' class='input' value='$r[pimpinan]'/></td>
		</tr>
		<tr>
